...
#define HTM_SGL_INIT_BUDGET 20
    ...
    extern void reset_timestamp(int threadId);
    extern void renew_timestamp(int threadId);
...
// #define CHECK_PAGE_FAULT(tid, budget, status)

// if not any of the known issues (5 bottom bits), we assume it will be
...
#define BEFORE_HTM_BEGIN(tid, budget) renew_timestamp(tid)
#define AFTER_HTM_BEGIN(tid, budget)  /* empty */

// this macro is being redefined ...
#define BEFORE_SGL_BEGIN(tid)         /* empty */
//#define AFTER_SGL_BEGIN(tid)  /* empty */
#define AFTER_SGL_BEGIN(tid)  renew_timestamp(tid)
        ...
        {                                                                          \
            ...
            {                                                                      \
                ...
                {                                                                  \
                    ...
                    CHECK_PAGE_FAULT(HTM_SGL_tid, HTM_SGL_budget, HTM_SGL_status); \
                    continue;                                                      \
                }                                                                  \
                CHECK_SGL_HTM();                                                   \
