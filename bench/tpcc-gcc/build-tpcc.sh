...
cp ../backends/$backend/tm.h ../backends/gcc-abi
cp ../backends/$backend/thread.c ../backends/gcc-abi
cp ../backends/$backend/thread.h ../backends/gcc-abi
# cp ../backends/$backend/Makefile .
cp ../backends/$backend/Makefile.flags ../backends/gcc-abi
cp ../backends/$backend/Defines.common.mk ../backends/gcc-abi

CPU_FREQ=$(cat CPU_FREQ_kHZ.txt | tr -d '[:space:]')

cd ../backends/gcc-abi
make clean
make -j8 -f Makefile DEF_CPU_FREQ=$CPU_FREQ $MAKEFILE_ARGS
cd -
