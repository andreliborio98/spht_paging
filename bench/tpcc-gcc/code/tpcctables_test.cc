...
static constexpr char CUSTOMER_FIRST[] = "foo4567890";
static constexpr char CUSTOMER_MIDDLE[] = "AB";
static constexpr char CUSTOMER_LAST[] = "bar4567890123456";
static constexpr float CUSTOMER_BALANCE = 123.45f;
static constexpr float CUSTOMER_DISCOUNT = 0.0003f;
static constexpr char NOW[] = "20080708012243";
static constexpr float AMOUNT = 1.23f;
static constexpr float W_TAX = 0.0001f;
static constexpr float D_TAX = 0.0002f;
static constexpr char ITEM_NAME[] = "12345678901234";
static constexpr char ITEM_DATA[] = "ORIGINAL9012345678901234";
static constexpr char STOCK_DIST[] = "12345678901234";
static constexpr char W_NAME[] = "wname";
static constexpr char D_NAME[] = "dname";
static constexpr char STREET[Address::MAX_STREET+1] = "maxstreet01234567890";

class TPCCTablesTest : public Test {
public:
    TPCCTablesTest() : undo_(NULL) {}

    static constexpr int32_t W_ID = Warehouse::MAX_WAREHOUSE_ID;
    static constexpr int32_t D_ID = 2;
    static constexpr int32_t C_ID = 3;
    static constexpr int32_t CARRIER_ID = 4;
    static constexpr int32_t O_ID = 3972;
    static constexpr int32_t SUPPLY_W_ID = 5;
    static constexpr int32_t QUANTITY = 6;
    static constexpr int32_t ITEM_IM_ID = 52;
