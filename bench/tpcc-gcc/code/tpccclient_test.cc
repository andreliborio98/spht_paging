...
public:
    ...
    static constexpr char NOW[DATETIME_SIZE+1];
};
...
protected:
    static constexpr int WAREHOUSES = 5;

    static constexpr int SMALL_ITEMS = 50;
    static constexpr int SMALL_DISTRICTS = 2;
    static constexpr int SMALL_CUSTOMERS = 20;
