...
{
    on_before_htm_begin  = on_before_htm_begin_pcwm_eadr;
    on_htm_abort         = on_htm_abort_pcwm_eadr;
    on_before_htm_write  = on_before_htm_write_8B_pcwm_eadr;
    on_before_htm_commit = on_before_htm_commit_pcwm_eadr;
    on_after_htm_commit  = on_after_htm_commit_pcwm_eadr;
...
void on_htm_abort_pcwm_eadr(int threadId) { /* empty */ }
...
void on_before_htm_write_8B_pcwm_eadr(int threadId, void *addr, uint64_t val)
{
    ...
    // Add to list of written addresses for this transaction
    txWriteAddress(addr, writeLogEnd); // Points directly to the val position in the log
...
void wait_commit_pcwm_eadr(int threadId) { /* empty */ }
