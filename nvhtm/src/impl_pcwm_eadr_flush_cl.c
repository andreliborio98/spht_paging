...
void on_htm_abort_pcwm_eadr_t3(int threadId) { /* empty */ }
...
void on_after_htm_commit_pcwm_eadr_t3(int threadId)
{
    ...
    if (writeLogStart != writeLogEnd) {
        ...
        // Smart close log might not be required since the timestamp marker was written on_before_htm_commit_pcwm_eadr_t3
...
void wait_commit_pcwm_eadr_t3(int threadId) { /* empty */ }
