...
// int isSharedHTM; //ANDRE UNCOMMENT NODE05
...
void install_bindings_htmOnly()
{
  ...
  on_before_non_tx_write = on_before_htm_non_tx_write;
...
void on_before_htm_non_tx_write (int threadId, void *addr, uint64_t val) { /* empty */ }
